/*
 * Autor (projektu): Petr Marek(xmarek69)
 *
 * Zmìny v souboru:
 * ZADNE
 *
 * Cely soubor je prevzaty z prikladu USB DEVICE z MQX RTOS
 */
...
extern bool USB_Desc_Valid_Configation(HID_HANDLE handle, 
                                                          uint16_t config_val); 

extern bool USB_Desc_Remote_Wakeup(HID_HANDLE handle); 
